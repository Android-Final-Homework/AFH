...
public class RecfindAdapter_Collect extends RecyclerView.Adapter<RecfindAdapter_Collect.ItemViewHolder> {
    ...
    public RecfindAdapter_Collect(Context context, List<FindBean.DataBean.RecordsBean> showList, String userId) {
