...
import com.example.photoshare.RecfindAdapter_focus;
...
public class focus extends AppCompatActivity {
    ...
    RecfindAdapter_focus recfindAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GetUserId();
        browse();
        floatingActionButton = findViewById(R.id.floatingActionButton_focus);
        recfindAdapter = new RecfindAdapter_focus(this, recordslocalList, userId);
        mRecyclerView = findViewById(R.id.recylerview_focus);
        ...
        Request request = new Request.Builder()//创建Request 对象。
                .url("http://47.107.52.7:88/member/photo/focus?userId=" + userId)
                .headers(headers)
                .build();
